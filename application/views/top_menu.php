<div id='top_menu' class='span-24 shadow'>
	<ul class='top_menu_ul'>
		...
		<li class='tm_item'>
			<a class='tm_link' href='<?php echo $this->linker->type_show('sunglasses'); ?>'>Sunglasses</a>
			<div class='tm_sub_wrapper'>
				<ul>
					...
					$count ++;
					?>
					<li><?php echo anchor($this->linker->brand_show($brand->id), $brand->name, array('class' => 'tm_sub_link')); ?></li>
					<?php } ?> 
				</ul>
			</div>
		</li>
		<li class='tm_item'><a class='tm_link' href='<?php echo $this->linker->type_show('eyeglasses'); ?>'>Eyeglasses</a></li>
